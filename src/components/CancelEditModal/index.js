...
function CancelEditModal({ discardEdition, onClose }) {
    ...
    return (
        <div className='modal-cancel-edit-backdrop'>
            <div className='modal-cancel-edit' >
                <h1>Tem certeza que deseja descartar as alterações?</h1>
                <div className='modal-cancel-edit__btns'>
                    <button className='btn-edit transform' type='button' onClick={discardEdition}>Sim</button>
                    <button className='btn-edit transform' type='button' onClick={onClose}>Não</button>
                </div>
            </div>
        </div>
    );
